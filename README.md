...
[ColdFront Website](https://coldfront.dev/)
...
For more information on installing and using ColdFront refer to the [documentation](https://docs.coldfront.dev).  
...
### Email Lists
We have two mailing lists available for the ColdFront community. To join either, please send an email to listserv@listserv.buffalo.edu with no subject, and the appropriate command in the body of the message, making sure to replace first_name last_name with your information.  
